...
namespace Art_Gallery.Controllers.ControllersAdmin
{
    public class EmployeesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,Email,Name,Password,Adress,PhoneNumber,Age,Sex")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,Email,Name,Password,Adress,PhoneNumber,Age,Sex")] Employee employee)
        {
            if (ModelState.IsValid)
            {
