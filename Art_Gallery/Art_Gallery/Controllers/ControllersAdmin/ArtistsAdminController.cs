...
namespace Art_Gallery.Controllers.ControllersAdmin
{
    public class ArtistsAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ArtistId,Name,Nationality,Age,Sex,Image")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ArtistId,Name,Nationality,Age,Sex,Image")] Artist artist)
        {
            if (ModelState.IsValid)
            {
