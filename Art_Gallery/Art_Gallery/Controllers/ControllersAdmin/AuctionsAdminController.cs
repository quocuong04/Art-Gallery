...
namespace Art_Gallery.Controllers.ControllersAdmin
{
    public class AuctionsAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AuctionId,EndDate,StartDate,Name")] Auction auction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AuctionId,EndDate,StartDate,Name")] Auction auction)
        {
            if (ModelState.IsValid)
            {
