...
namespace Art_Gallery.Controllers.ControllersAdmin
{
    public class CustomersAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Email,Name,ReditCard,Password,Address,PhoneNumber,Age,Sex,CustomerId,FavoriteArtwork")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Email,Name,ReditCard,Password,Address,PhoneNumber,Age,Sex,CustomerId,FavoriteArtwork")] Customer customer)
        {
            if (ModelState.IsValid)
            {
